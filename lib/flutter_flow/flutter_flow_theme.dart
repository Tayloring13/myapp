...
abstract class FlutterFlowTheme {
  ...
  late Color m3StateLayersLightOnPrimaryOpacity008;
  late Color m3SysLightOnSecondaryContainer;
  late Color m3SysLightOnPrimary;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color customColor1 = const Color(0xFF1D1B20);
  late Color customColor2 = const Color(0xFF1E1E1E);
  late Color customColor3 = const Color(0xFFFFFFFF);
  late Color customColor4 = const Color(0xFF4A4459);
  late Color customColor5 = const Color(0xFFFFFFFF);
  late Color m3SysLightOnSurface = const Color(0xFF1D1B20);
  late Color m3StateLayersLightOnPrimaryOpacity008 = const Color(0x14FFFFFF);
  late Color m3SysLightOnSecondaryContainer = const Color(0xFF4A4459);
  late Color m3SysLightOnPrimary = const Color(0xFFFFFFFF);
}
