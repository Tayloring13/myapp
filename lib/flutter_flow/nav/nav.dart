...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: BuddyWidget.routeName,
          path: BuddyWidget.routePath,
          builder: (context, params) => BuddyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ListeningWidget.routeName,
          path: ListeningWidget.routePath,
          builder: (context, params) => ListeningWidget(),
        ),
        FFRoute(
