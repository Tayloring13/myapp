              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Just a couple of questions so I can \nget to know you better',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.poppins(
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Great! Now help me match your vibe',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.poppins(
                              fontWeight: FontWeight.w600,
                              fontStyle: FlutterFlowTheme.of(context)
              ...
              Row(
                ...
                children: [
                  Container(
                    width: 350.0,
                    child: Slider(
                      activeColor: Color(0xFFACCA32),
                      inactiveColor: FlutterFlowTheme.of(context).alternate,
                      min: 0.0,
                      max: 10.0,
                      value: _model.sliderValue1 ??= _model.chillAllInValue,
                      onChanged: (newValue) async {
                        newValue = double.parse(newValue.toStringAsFixed(2));
                        safeSetState(() => _model.sliderValue1 = newValue);
                        _model.chillAllInValue = _model.sliderValue1!;
                        safeSetState(() {});
                      },
                    ),
                  ),
                    ...
                    Container(
                      ...
                      child: Slider(
                        ...
                        value: _model.sliderValue2 ??=
                            _model.quickHitsDeepDivesValue,
                        onChanged: (newValue) {
                          newValue = double.parse(newValue.toStringAsFixed(2));
                    ...
                    Container(
                      ...
                      child: Slider(
                        ...
                        value: _model.sliderValue3 ??=
                            _model.templeFoodiePopCultureValue,
                        onChanged: (newValue) {
                          newValue = double.parse(newValue.toStringAsFixed(2));
